...
import { getUsuarioAutenticado, login, register, setUsuarioAutenticado } from "./login/login.js";
...
function setSession(session){
   ...
   if ( session.autenticado ) {
    ...
    d.querySelector(".btnLogin").textContent = session.email;
    d.querySelector(".btnRegister").textContent = "Logout";
